...
<html>
  <head>
    <title>ChessG</title>
      ...
      <link rel="stylesheet" href="steinitz.css">
  </head>
  <body>
  <div id="top"></div>
...
<div id="gamePlayerInfo">
    <div class="player"><span id="player2">Wilhelm Steinitz (2650)</span></div>
...
<div class="card">
  <div class="content">
    <p class="heading"><img src="champion-img/Steinitz.png" alt="world-champion-img" width="250" height="300"></p>
    <p class="para">
    <div style="margin-bottom:20px; text-align:center">
    <a style="font-weight: bold;">Wilhelm Steinitz</a></div>
    <br><div style="margin-bottom: 1px; font-size: 17px; text-align:center;">
<a style="font-weight: bold;">Federation</a> <a>Austria</a>
</div>
<div style="text-align:center;">
      ...
      <br>Wilhelm Steinitz was an Austrian master and the first official world champion.  He held the title from 1886-1894, after dominating the chess scene for decades before.  He was undefeated in match play for over 30 years (1862-1894). In 1859-1961, bold attacking performances in the Vienna City Championships earned him the nickname "Austrian Morphy". From 1873-1882, Steinitz went on a historic 25 game winning streak.  In the early 1870s he introduced a new style of play, and is subsequently regarded as the father of positional chess.
      <div>
  </div>
</div>
