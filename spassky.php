...
<html>
  <head>
    <title>ChessG</title>
      ...
      <link rel="stylesheet" href="spassky.css">
  </head>
  <body>
  <div id="top"></div>
...
<div id="gamePlayerInfo">
    <div class="player"><span id="player2">Boris Spassky (2690)</span></div>
...
<div class="card">
  <div class="content">
    <p class="heading"><img src="champion-img/Spassky.png" alt="world-champion-img" width="250" height="300"></p>
    <p class="para">
    <div style="margin-bottom:20px; text-align:center">
    <a style="font-weight: bold;">Boris Spassky</a></div>
...
<div style="text-align:center;">
      ...
      <a style="font-weight: bold;">Years of life</a> <a>age 88</a>
</div>
      <div style="margin-top: 34px;">
      <br>Boris Spassky was born in Leningrad on January 30, 1937, and became the 10th World Chess Champion in 1969. He was famous for his versatile style and was equally comfortable in any position. His fight for the World Championship title with American Robert Fischer made his name known even in circles far removed from chess, but it would be a mistake to remember him only for this match. 
      <div>
  </div>
</div>
