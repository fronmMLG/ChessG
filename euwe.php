...
<html>
  <head>
    <title>ChessG</title>
      ...
      <link rel="stylesheet" href="euwe.css">
  </head>
  <body>
  <div id="top"></div>
...
<div id="gamePlayerInfo">
    <div class="player"><span id="player2">Max Euwe (2650)</span></div>
...
<div class="card">
  <div class="content">
    <p class="heading"><img src="champion-img/Euwe.png" alt="world-champion-img" width="250" height="300"></p>
    <p class="para">
    <div style="margin-bottom:20px; text-align:center">
    <a style="font-weight: bold;">Max Euwe</a></div>
    <br><div style="margin-bottom: 1px; font-size: 17px; text-align:center;">
<a style="font-weight: bold;">Federation</a> <a>Netherlands</a>
</div>
<div style="text-align:center;">
      <br style="margin-bottom: 1px; font-size:17px;">
      <a style="font-weight: bold;">Years of life</a> <a>age 80</a>
</div>
      <div style="margin-top: 34px;">
      <br>Max Euwe is the fifth World Chess Champion, who held the chess crown from 1935 to 1937, the first grandmaster from the Netherlands, FIDE President from 1970 to 1978, and the author of dozens of books about chess. The match against Alekhine, over most of 30 games, began disastrously for the challenger, who was losing 3-6 after 9 games. Among the versions of what happened next, the bad habits of the world champion and underestimation of his opponent are often mentioned, but it is worth noting that Alekhine made risky decisions throughout the match, and Euwe gradually learned to find the weak points of his plans. After the 14th game the score was tied: 7-7, and after the 26th Euwe was ahead by two points: 14-12, and Alekhine was only able to reduce the gap in the match, which ended with a minimal advantage for the challenger: 15.5-14.5.   
      <div>
  </div>
</div>
