...
<html>
  <head>
    <title>ChessG</title>
      ...
      <link rel="stylesheet" href="capablanca.css">
  </head>
  <body>
  <div id="top"></div>
...
<div id="gamePlayerInfo">
    <div class="player"><span id="player2">Jose Raul Capablanca (2725)</span></div>
...
<div class="card">
  <div class="content">
    <p class="heading"><img src="champion-img/Capablanca.png" alt="world-champion-img" width="250" height="300"></p>
    <p class="para">
    <div style="margin-bottom:20px; text-align:center">
    <a style="font-weight: bold;">Jose Raul Capablanca</a></div>
    <br><div style="margin-bottom: 1px; font-size: 17px; text-align:center;">
<a style="font-weight: bold;">Federation</a> <a>Cuba</a>
</div>
<div style="text-align:center;">
      ...
      <br>Jose Raul Capablanca was the third World Chess Champion (1921-1927), and one of the greatest chess players of all time . He was called a "chess machine"  for his flawless endgame play. The Lasker-Capablanca match began in 1921 in Havana, Cuba. The match was scheduled to go to 6 wins, but Lasker resigned after the 14th game, when Capablanca was leading with 4 wins and 10 draws. Capablanca became the first champion in history to win the title without losing a single game in the match.
      <div>
  </div>
</div>
