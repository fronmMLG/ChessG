...
<html>
  <head>
    <title>ChessG</title>
      ...
      <link rel="stylesheet" href="dommaraju.css">
  </head>
  <body>
  <div id="top"></div>
...
<div id="gamePlayerInfo">
    <div class="player"><span id="player2">Gukesh Dommaraju (2794)</span></div>
...
<div class="card">
  <div class="content">
    <p class="heading"><img src="champion-img/Dommaraju.png" alt="world-champion-img" width="250" height="300"></p>
    <p class="para">
    <div style="margin-bottom:20px; text-align:center">
    <a style="font-weight: bold;">Gukesh Dommaraju</a></div>
