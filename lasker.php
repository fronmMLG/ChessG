...
<html>
  <head>
    <title>ChessG</title>
      ...
      <link rel="stylesheet" href="lasker.css">
  </head>
  <body>
  <div id="top"></div>
...
<div id="gamePlayerInfo">
    <div class="player"><span id="player2">Emanuel Lasker (2720)</span></div>
...
<div class="card">
  <div class="content">
    <p class="heading"><img src="champion-img/Lasker.png" alt="world-champion-img" width="250" height="300"></p>
    <p class="para">
    <div style="margin-bottom:20px; text-align:center">
    <a style="font-weight: bold;">Emanuel Lasker</a></div>
    <br><div style="margin-bottom: 1px; font-size: 17px; text-align:center;">
<a style="font-weight: bold;">Federation</a> <a>Germany</a>
</div>
<div style="text-align:center;">
      <br style="margin-bottom: 1px; font-size:17px;">
      <a style="font-weight: bold;">Years of life</a> <a>age 72</a>
</div>
      <div style="margin-top: 34px;">
      <br>Emanuel Lasker is the second World Chess Champion and one of the greatest chess players of all time . He reigned for a record 27 years from 1894 to 1921 and successfully defended his title five times. In 1921, he had to play a match with Capablanca in Havana , where Lasker was in poor form due to the tropical climate and insufficient chess preparation. After 10 draws and four losses, the world champion resigned early, acknowledging Capablanca's victory with a score of 9-5.  
      <div>
  </div>
</div>
