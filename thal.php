...
<html>
  <head>
    <title>ChessG</title>
      ...
      <link rel="stylesheet" href="thal.css">
  </head>
  <body>
  <div id="top"></div>
...
<div id="gamePlayerInfo">
    <div class="player"><span id="player2">Mikhail Tal (2705)</span></div>
...
<div class="card">
  <div class="content">
    <p class="heading"><img src="champion-img/Thal.png" alt="world-champion-img" width="250" height="300"></p>
    <p class="para">
    <div style="margin-bottom:20px; text-align:center">
    <a style="font-weight: bold;">Mikhail Tal</a></div>
    <br><div style="margin-bottom: 1px; font-size: 17px; text-align:center;">
<a style="font-weight: bold;">Federation</a> <a>Latvia</a>
</div>
<div style="text-align:center;">
      ...
      <br>Mikhail Tal is the eighth World Chess Champion and six-time USSR Champion, nicknamed the "Riga Magician" for his unique combinational style. Offering his opponents positional sacrifices of pieces and pawns, he won many beautiful games and the World Championship match in 1960. 
      <div>
  </div>
</div>
