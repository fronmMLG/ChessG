...
<html>
  <head>
    <title>ChessG</title>
      ...
      <link rel="stylesheet" href="smyslov.css">
  </head>
  <body>
  <div id="top"></div>
...
<div id="gamePlayerInfo">
    <div class="player"><span id="player2">Vasily Smyslov (2620)</span></div>
...
<div class="card">
  <div class="content">
    <p class="heading"><img src="champion-img/Smyslov.png" alt="world-champion-img" width="250" height="300"></p>
    <p class="para">
    <div style="margin-bottom:20px; text-align:center">
    <a style="font-weight: bold;">Vasily Smyslov</a></div>
...
<div style="text-align:center;">
      ...
      <a style="font-weight: bold;">Years of life</a> <a>age: 89</a>
</div>
      <div style="margin-top: 34px;">
      <br>Vasily Smyslov is the seventh World Chess Champion (1957-1958), the holder of the record for the most Chess Olympiad medals (17), and a two-time USSR Champion (in 1949 and 1955). Smyslov played chess at the highest level for over four decades, becoming a contender for the World Championship in the 1940s, 1950s, 1960s, and 1980s.
      <div>
  </div>
</div>
