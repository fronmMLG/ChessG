...
<html>
  <head>
    <title>ChessG</title>
      ...
      <link rel="stylesheet" href="karpov.css">
  </head>
  <body>
  <div id="top"></div>
...
<div id="gamePlayerInfo">
    <div class="player"><span id="player2">Anatoly Karpov (2780)</span></div>
...
<div class="card">
  <div class="content">
    <p class="heading"><img src="champion-img/Karpov.png" alt="world-champion-img" width="250" height="300"></p>
    <p class="para">
    <div style="margin-bottom:20px; text-align:center">
    <a style="font-weight: bold;">Anatoly Karpov</a></div>
...
<div style="text-align:center;">
      ...
      <a style="font-weight: bold;">Years of life</a> <a>age 73</a>
</div>
      <div style="margin-top: 34px;">
      <br>Anatoly Karpov, the 12th World Champion and one of the greatest chess players of all time , was born on May 23, 1951, in the city of Zlatoust in the Urals. In just one Candidates Cycle, he went from being a young grandmaster to becoming World Champion and spent 10 years on the chess throne, from 1975 to 1985. With his creativity, sporting achievements, and social activities, Karpov had a huge influence on the development of chess throughout the world.
      <div>
  </div>
</div>
