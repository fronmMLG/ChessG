...
<div id="gamePlayerInfo">
    <div class="player"><span id="player2">Viswanathan Anand (2817)</span></div>
...
<div class="card">
  <div class="content">
    <p class="heading"><img src="champion-img/Anand.png" alt="world-champion-img" width="250" height="300"></p>
    <p class="para">
    <div style="margin-bottom:20px; text-align:center">
    <a style="font-weight: bold;">Viswanathan Anand</a></div>
    <br><div style="margin-bottom: 1px; font-size: 17px; text-align:center;">
<a style="font-weight: bold;">Federation</a> <a>India</a>
</div>
<div style="text-align:center;">
      ...
      <br>Viswanathan Anand is the 15th World Chess Champion and the greatest chess player in Indian history. He played his first World Championship match in 1995, became the FIDE World Champion in 2000, and became the undisputed World Champion in 2007. He held the title for six years, from 2007 to 2013, and is now successfully continuing his career at an age when many chess players are ending theirs.
      <div>
  </div>
</div>
