...
<html>
  <head>
    <title>ChessG</title>
      ...
      <link rel="stylesheet" href="kramnik.css">
  </head>
  <body>
  <div id="top"></div>
...
<div id="gamePlayerInfo">
    <div class="player"><span id="player2">Vladimir Kramnik (2817)</span></div>
...
<div class="card">
  <div class="content">
    <p class="heading"><img src="champion-img/Kramnik.png" alt="world-champion-img" width="250" height="300"></p>
    <p class="para">
    <div style="margin-bottom:20px; text-align:center">
    <a style="font-weight: bold;">Vladimir Kramnik</a></div>
...
<div style="text-align:center;">
      ...
      <a style="font-weight: bold;">Years of life</a> <a>age 49</a>
</div>
      <div style="margin-top: 34px;">
      <br>Vladimir Kramnik is the 14th World Champion, having won a match against Garry Kasparov in 2000. In 2006, after defeating Veselin Topalov , he became the recognized World Champion, ending the period of holding two championship titles in parallel. In January 1993, Kramnik entered the top ten strongest chess players in the world for the first time and did not leave it for 26 years - until January 2019. Kramnik is the second chess player in history to reach the 2800 Elo rating mark and the only one to become No. 1 in the world by rating during Kasparov's championship years.
  </div>
</div>
