...
<div id="gamePlayerInfo">
    <div class="player"><span id="player2">Bobby Fischer (2785)</span></div>
...
<div class="card">
  <div class="content">
    <p class="heading"><img src="champion-img/Fisher.png" alt="world-champion-img" width="250" height="300"></p>
    <p class="para">
    <div style="margin-bottom:20px; text-align:center">
    <a style="font-weight: bold;">Bobby Fischer</a></div>
    <br><div style="margin-bottom: 1px; font-size: 17px; text-align:center;">
<a style="font-weight: bold;">Federation</a> <a>United States</a>
</div>
<div style="text-align:center;">
      <br style="margin-bottom: 1px; font-size:17px;">
      <a style="font-weight: bold;">Years of life</a> <a>age 64</a>
</div>
      <div style="margin-top: 34px;">
      <br>Robert James Fischer is the 11th World Champion and the most famous chess player of the 20th century. During his career, he set many records: the age of receiving the title of grandmaster, the longest winning streak, the highest rating... These and other achievements were surpassed only after decades or are still relevant today. Fischer's victories on the way to the world championship title remain the most remarkable successes in chess history, and an entire generation of chess players grew up on his games. One of Fischer's most famous aphorisms best sums up his attitude to the game: "Chess requires complete concentration."
      <div>
  </div>
</div>
