...
<html>
  <head>
    <title>ChessG</title>
      ...
      <link rel="stylesheet" href="alekhine.css">
  </head>
  <body>
  <div id="top"></div>
...
<div id="gamePlayerInfo">
    <div class="player"><span id="player2">Alexander Alekhine (2730)</span></div>
...
<div class="card">
  <div class="content">
    <p class="heading"><img src="champion-img/Alekhine.png" alt="world-champion-img" width="250" height="300"></p>
    <p class="para">
    <div style="margin-bottom:20px; text-align:center">
    <a style="font-weight: bold;">Alexander Alekhine</a></div>
...
<div style="text-align:center;">
      ...
      <a style="font-weight: bold;">Years of life</a> <a>age 53</a>
</div>
      <div style="margin-top: 34px;">
      <br>Alexander Alekhine is one of the greatest chess players of all time. He became the fourth World Chess Champion and remained so for 17 years, second only to Emanuel Lasker . He is the only World Champion to die undefeated.

Alekhine's brilliant talent was evident in all aspects of chess both on and off the board. It is not without reason that he is considered one of the 10 greatest chess players of all time . Alekhine is known for his tactical acumen and combinatory ingenuity in complex and sharp positions, but he also played calm positions and endings very well. His contribution to chess theory is enormous. Several variations in various openings and, of course, the Alekhine Defense (1. e4 Nf6) are named after him. Many consider Alekhine's books to be among the best chess books of all time .
  </div>
</div>
